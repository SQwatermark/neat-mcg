...
public class NeatConfig {
    ...
    public static void init(File configFile) {
        ...
        config.load();
        load();
        MinecraftForge.EVENT_BUS.register(new NeatConfig.ChangeListener());
    }

    public static void load() {
        drawName = loadPropBool("Show Name", drawName);
        ...
        Property prop = config.get("general", "Blacklist", new String[]{"Shulker", "ArmorStand", "CustomNpc"});
    ...
    public static class ChangeListener {
        ...
        public void onConfigChanged(OnConfigChangedEvent eventArgs) {
            if (eventArgs.getModID().equals("neat")) {
                NeatConfig.load();
            }
        }
    }
